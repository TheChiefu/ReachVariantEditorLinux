   ...
   namespace enums {
      DetailedEnum object_type = DetailedEnum({
         DetailedEnumValue("spartan",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bipd"), "objects/characters/spartans/spartans")
         ),
         DetailedEnumValue("elite",
            DetailedEnumValueInfo::make_friendly_name("Elite Biped"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bipd"), "objects/characters/elite/elite")
         ),
         DetailedEnumValue("monitor",
            DetailedEnumValueInfo::make_friendly_name("Monitor Biped"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bipd"), "objects/characters/monitor/monitor_editor")
         ),
         DetailedEnumValue("flag",
            DetailedEnumValueInfo::make_friendly_name("Flag"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/multiplayer/flag/flag"),
         ...
         DetailedEnumValue("bomb",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/multiplayer/assault_bomb/assault_bomb"),
         ...
         DetailedEnumValue("skull",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/multiplayer/skull/skull"),
         ...
         DetailedEnumValue("hill_marker",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/models/mp_hill_beacon/mp_hill_beacon"),
         ...
         DetailedEnumValue("flag_stand",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/models/mp_flag_base/mp_flag_base"),
         ...
         DetailedEnumValue("capture_plate",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/models/mp_circle/mp_circle"),
         ...
         DetailedEnumValue("frag_grenade",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/weapons/grenade/frag_grenade/frag_grenade")
         ),
         DetailedEnumValue("plasma_grenade",
            DetailedEnumValueInfo::make_friendly_name("Plasma Grenade"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/weapons/grenade/plasma_grenade/plasma_grenade")
         ),
         ...
         DetailedEnumValue("dmr",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/dmr/dmr")
         ),
         DetailedEnumValue("assault_rifle",
            DetailedEnumValueInfo::make_friendly_name("Assault Rifle"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/assault_rifle/assault_rifle")
         ),
         DetailedEnumValue("plasma_pistol",
            DetailedEnumValueInfo::make_friendly_name("Plasma Pistol"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/pistol/plasma_pistol/plasma_pistol")
         ),
         DetailedEnumValue("spiker",
            DetailedEnumValueInfo::make_friendly_name("Spiker"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/spike_rifle/spike_rifle")
         ),
         ...
         DetailedEnumValue("needle_rifle",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/needle_rifle/needle_rifle")
         ),
         DetailedEnumValue("plasma_repeater",
            DetailedEnumValueInfo::make_friendly_name("Plasma Repeater"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/plasma_repeater/plasma_repeater")
         ),
         DetailedEnumValue("energy_sword",
            DetailedEnumValueInfo::make_friendly_name("Energy Sword"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/melee/energy_sword/energy_sword")
         ),
         DetailedEnumValue("magnum",
            DetailedEnumValueInfo::make_friendly_name("Magnum"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/pistol/magnum/magnum")
         ),
         DetailedEnumValue("needler",
            DetailedEnumValueInfo::make_friendly_name("Needler"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/pistol/needler/needler")
         ),
         DetailedEnumValue("plasma_rifle",
            DetailedEnumValueInfo::make_friendly_name("Plasma Rifle"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/plasma_rifle/plasma_rifle")
         ),
         DetailedEnumValue("rocket_launcher",
            DetailedEnumValueInfo::make_friendly_name("Rocket Launcher"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/support_high/rocket_launcher/rocket_launcher")
         ),
         DetailedEnumValue("shotgun",
            DetailedEnumValueInfo::make_friendly_name("Shotgun"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/shotgun/shotgun")
         ),
         DetailedEnumValue("sniper_rifle",
            DetailedEnumValueInfo::make_friendly_name("Sniper Rifle"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/sniper_rifle/sniper_rifle")
         ),
         ...
         DetailedEnumValue("beam_rifle", // actually spawns a Focus Rifle
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/focus_rifle/focus_rifle"),
         ...
         DetailedEnumValue("spartan_laser",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/support_high/spartan_laser/spartan_laser")
         ),
         DetailedEnumValue("gravity_hammer",
            DetailedEnumValueInfo::make_friendly_name("Gravity Hammer"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/melee/gravity_hammer/gravity_hammer")
         ),
         ...
         DetailedEnumValue("warthog",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/warthog/warthog"),
         ...
         DetailedEnumValue("ghost",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/ghost/ghost")
         ),
         DetailedEnumValue("scorpion",
            DetailedEnumValueInfo::make_friendly_name("Scorpion"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/scorpion/scorpion")
         ),
         DetailedEnumValue("wraith",
            DetailedEnumValueInfo::make_friendly_name("Wraith"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/wraith/wraith")
         ),
         DetailedEnumValue("banshee",
            DetailedEnumValueInfo::make_friendly_name("Banshee"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/banshee/banshee")
         ),
         DetailedEnumValue("mongoose",
            DetailedEnumValueInfo::make_friendly_name("Mongoose"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/mongoose/mongoose")
         ),
         ...
         DetailedEnumValue("stingray",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "")
         ),
         ...
         DetailedEnumValue("falcon",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/falcon/falcon")
         ),
         DetailedEnumValue("sabre",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/sabre/sabre"),
         ...
         DetailedEnumValue("sprint",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/sprint/sprint")
         ),
         DetailedEnumValue("jetpack",
            DetailedEnumValueInfo::make_friendly_name("Jetpack"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/jet_pack/jet_pack")
         ),
         DetailedEnumValue("armor_lock",
            DetailedEnumValueInfo::make_friendly_name("Armor Lock"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/armor_lockup/armor_lockup")
         ),
         DetailedEnumValue("power_fist",
            DetailedEnumValueInfo::make_unused_sentinel(),
            DetailedEnumValueInfo::make_friendly_name("Unused (Power Fist AA)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "")
         ),
         DetailedEnumValue("active_camo_aa",
            DetailedEnumValueInfo::make_friendly_name("Active Camo (Armor Ability)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/active_camouflage/active_camouflage")
         ),
         ...
         DetailedEnumValue("revenant",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/revenant/revenant")
         ),
         DetailedEnumValue("pickup_truck",
            DetailedEnumValueInfo::make_flags(DetailedEnumValueInfo::flags::is_thorage),
            DetailedEnumValueInfo::make_friendly_name("Pickup Truck"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/civilian/pickup/pickup"),
         ...
         DetailedEnumValue("territory_static", // Halo 3 leftover from before Forge labels were invented
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), ""),
         ...
         DetailedEnumValue("respawn_zone",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/spawning/respawn_zone"),
         ...
         DetailedEnumValue("plasma_launcher",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/support_high/plasma_launcher/plasma_launcher")
         ),
         DetailedEnumValue("fusion_coil",
            DetailedEnumValueInfo::make_friendly_name("Fusion Coil"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/gear/human/military/fusion_coil/fusion_coil")
         ),
         DetailedEnumValue("unsc_shield_generator",
            DetailedEnumValueInfo::make_unused_sentinel(),
            DetailedEnumValueInfo::make_friendly_name("unsc_shield_generator"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "")
         ),
         ...
         DetailedEnumValue("initial_spawn_point",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/spawning/initial_spawn_point")
         ),
         ...
         DetailedEnumValue("vehicle_req_floor",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "")
         ),
         DetailedEnumValue("wall_switch",
            DetailedEnumValueInfo::make_unused_sentinel(),
            DetailedEnumValueInfo::make_friendly_name("wall_switch"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("ctrl"), "")
         ),
         DetailedEnumValue("health_pack",
            DetailedEnumValueInfo::make_friendly_name("Health Pack"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("ctrl"), "objects/levels/shared/device_controls/health_station/health_station")
         ),
         ...
         DetailedEnumValue("semi_truck",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/civilian/truck_cab_large/truck_cab_large")
         ),
         DetailedEnumValue("soccer_ball",
            DetailedEnumValueInfo::make_friendly_name("Soccer Ball"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/soccer_ball/soccer_ball"),
         ...
         DetailedEnumValue("golf_ball",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/golf_ball/golf_ball"),
         ...
         DetailedEnumValue("golf_club",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/levels/shared/golf_club/golf_club")
         ),
         DetailedEnumValue("golf_cup",
            DetailedEnumValueInfo::make_friendly_name("Golf Cup"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/golf_cup/golf_cup")
         ),
         ...
         DetailedEnumValue("dice",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/dice/dice"),
         ...
         DetailedEnumValue("covenant_crate",
            DetailedEnumValueInfo::make_unused_sentinel(),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/props/covenant/crate_space/crate_space"),
         ...
         DetailedEnumValue("glow_stick",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/props/human/unsc/unsc_glow_stick/unsc_glow_stick"),
         ...
         DetailedEnumValue("concussion_rifle",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/concussion_rifle/concussion_rifle")
         ),
         DetailedEnumValue("grenade_launcher",
            DetailedEnumValueInfo::make_friendly_name("Grenade Launcher"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/rifle/grenade_launcher/grenade_launcher")
         ),
         ...
         DetailedEnumValue("hologram",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/hologram/hologram")
         ),
         DetailedEnumValue("evade",
            DetailedEnumValueInfo::make_friendly_name("Evade"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/evade/evade")
         ),
         DetailedEnumValue("unsc_data_core",
            DetailedEnumValueInfo::make_friendly_name("UNSC Data Core"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/multiplayer/unsc_data_core/unsc_data_core"),
         ...
         DetailedEnumValue("danger_zone",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/spawning/danger_zone"),
         ...
         DetailedEnumValue("teleporter_sender",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/teleporter_sender/teleporter_sender"),
         ...
         DetailedEnumValue("teleporter_receiver",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/teleporter_receiver/teleporter_receiver"),
         ...
         DetailedEnumValue("teleporter_2way",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/teleporter_2way/teleporter_2way"),
         ...
         DetailedEnumValue("particle_emitter_fire",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/invisible_cube_of_derek/invisible_cube_of_derek"),
         ...
         DetailedEnumValue("phantom",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/phantom/phantom_mp")
         ),
         DetailedEnumValue("pelican",
            DetailedEnumValueInfo::make_friendly_name("Pelican (Device)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "The animated device machine used on Spire.")
         ),
         ...
         DetailedEnumValue("covenant_drop_pod",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "objects/levels/multi/70_boneyard/covy_drop_pod/covy_drop_pod"),
         ...
         DetailedEnumValue("respawn_zone_weak",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/spawning/weak_respawn_zone"),
         ...
         DetailedEnumValue("respawn_zone_weak_anti",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/spawning/weak_anti_respawn_zone"),
         ...
         DetailedEnumValue("phantom_device",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "objects/vehicles/covenant/phantom/phantom")
         ),
         DetailedEnumValue("resupply_capsule",
            DetailedEnumValueInfo::make_friendly_name("Resupply Capsule"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/gear/human/military/resupply_capsule/resupply_capsule"),
         ...
         DetailedEnumValue("weapon_box",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/gear/human/military/weapon_box/weapon_box"),
         ...
         DetailedEnumValue("initial_loadout_camera",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/generic/mp_cinematic_camera")
         ),
         DetailedEnumValue("invisible_covenant_resupply_capsule",
            DetailedEnumValueInfo::make_friendly_name("invis_cov_resupply_capsule"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "objects/levels/shared/device_machines/invis_cob_resupply_capsule/invis_cov_resully_capsule"),
         ...
         DetailedEnumValue("covenant_power_core",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/multiplayer/cov_power_module/cov_power_module")
         ),
         DetailedEnumValue("fuel_rod_gun",
            DetailedEnumValueInfo::make_friendly_name("Fuel Rod Gun"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/support_high/flak_cannon/flak_cannon")
         ),
         ...
         DetailedEnumValue("shield_door_small",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/props/covenant/shield_door_small/shield_door_small"),
         ...
         DetailedEnumValue("shield_door_medium",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/props/covenant/shield_door_medium/shield_door_medium"),
            DetailedEnumValueInfo::make_description("Defined on some Firefight maps, including Courtyard.")
         ),
         DetailedEnumValue("shield_door_large",
            DetailedEnumValueInfo::make_unused_sentinel(),
            DetailedEnumValueInfo::make_friendly_name("shield_door_large"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/props/covenant/shield_door_large/shield_door_large"),
            DetailedEnumValueInfo::make_description("Defined on some Firefight maps, including Courtyard.")
         ),
         DetailedEnumValue("drop_shield",
            DetailedEnumValueInfo::make_friendly_name("Drop Shield (Armor Ability)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("eqip"), "objects/equipment/drop_shield/drop_shield")
         ),
         DetailedEnumValue("detached_machine_gun_turret",
            DetailedEnumValueInfo::make_friendly_name("Machine Gun Turret (Detached)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/vehicles/human/turrets/machinegun/weapon/machinegun_turret/machinegun_turret"),
         ...
         DetailedEnumValue("machine_gun_turret",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/turrets/machinegun/machinegun"),
         ...
         DetailedEnumValue("detached_plasma_cannon",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/vehicles/covenant/turrets/plasma_turret/weapon/plasma_turret/plasma_turret"),
            DetailedEnumValueInfo::make_description("An infantry-operable turret that has been detached from its stand. It has a finite ammo supply and cannot be refilled. It can be carried in addition to a primary and secondary weapon, but will slow its user's movement.")
         ),
         DetailedEnumValue("plasma_cannon",
            DetailedEnumValueInfo::make_friendly_name("Plasma Cannon"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/turrets/plasma_turret/plasma_turret_mounted"),
            DetailedEnumValueInfo::make_description("An infantry-operable turret mounted on a stand. While mounted, the turret has unlimited ammo but cannot be moved; if the stand is broken, the turret can be carried but will have a finite ammo supply.")
         ),
         DetailedEnumValue("shade",
            DetailedEnumValueInfo::make_friendly_name("Shade Turret"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/turrets/shade/shade")
         ),
         ...
         DetailedEnumValue("electric_cart",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/civilian/cart_electric/cart_electric"),
         ...
         DetailedEnumValue("forklift",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/civilian/forklift/forklift")
         ),
         ...
         DetailedEnumValue("oni_van",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/civilian/oni_van/oni_van"),
         ...
         DetailedEnumValue("warthog_turret",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/warthog/weapons/warthog_chaingun/warthog_chaingun"),
         ...
         DetailedEnumValue("warthog_turret_gauss",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/warthog/weapons/warthog_gauss/warthog_gauss"),
         ...
         DetailedEnumValue("warthog_turret_rocket",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/warthog/weapons/warthog_rocket/warthog_rocket"),
         ...
         DetailedEnumValue("scorpion_turret_anti_infantry",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/scorpion/turrets/scorpion_anti_infantry/scorpion_anti_infantry")
         ),
         DetailedEnumValue("falcon_turret_grenade_left",
            DetailedEnumValueInfo::make_friendly_name("Falcon Turret (Grenade Left)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/falcon/turrets/falcon_side_grenade_left/falcon_side_grenade_left")
         ),
         DetailedEnumValue("falcon_turret_grenade_right",
            DetailedEnumValueInfo::make_friendly_name("Falcon Turret (Grenade Right)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/human/falcon/turrets/falcon_side_grenade_right/falcon_side_grenade_right")
         ),
         DetailedEnumValue("wraith_turret_anti_infantry",
            DetailedEnumValueInfo::make_friendly_name("Wraith Turret (Anti-Infantry)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/wraith/turrets/wraith_anti_infantry/wraith_anti_infantry")
         ),
         DetailedEnumValue("landmine",
            DetailedEnumValueInfo::make_friendly_name("Land Mine"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/multi/land_mine/land_mine")
         ),
         DetailedEnumValue("target_locator",
            DetailedEnumValueInfo::make_friendly_name("Target Locator"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "objects/weapons/pistol/target_laser/target_laser"),
         ...
         DetailedEnumValue("block_1x1_flat",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_plat_1x1_flat/ff_plat_1x1_flat"),
         ...
         DetailedEnumValue("shade_gun_anti_air",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/turrets/shade/weapons/shade_anti_air_cannon/shade_anti_air_cannon"),
         ...
         DetailedEnumValue("shade_gun_fuel_rod",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/turrets/shade/weapons/shade_flak_cannon/shade_flak_cannon"),
         ...
         DetailedEnumValue("shade_gun_plasma",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("vehi"), "objects/vehicles/covenant/turrets/shade/weapons/shade_plasma_cannon/shade_plasma_cannon"),
         ...
         DetailedEnumValue("kill_ball",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/damage_sphere/damage_sphere")
         ),
         DetailedEnumValue("light_red",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Red)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_red/ff_light_red")
         ),
         DetailedEnumValue("light_blue",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Blue)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_blue/ff_light_blue")
         ),
         DetailedEnumValue("light_green",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Green)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_green/ff_light_green")
         ),
         DetailedEnumValue("light_orange",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Orange)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_orange/ff_light_orange")
         ),
         DetailedEnumValue("light_purple",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Purple)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_purple/ff_light_purple")
         ),
         DetailedEnumValue("light_yellow",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Yellow)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_yellow/ff_light_yellow")
         ),
         DetailedEnumValue("light_white",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (White)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_white/ff_light_white")
         ),
         DetailedEnumValue("light_red_flashing",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Flashing Red)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_flash_red/ff_light_flash_red")
         ),
         DetailedEnumValue("light_yellow_flashing",
            DetailedEnumValueInfo::make_friendly_name("Forge Light (Flashing Yellow)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_light_flash_yellow/ff_light_flash_yellow")
         ),
         DetailedEnumValue("fx_colorblind",
            DetailedEnumValueInfo::make_friendly_name("FX (Colorblind)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/colorblind")
         ),
         DetailedEnumValue("fx_gloomy",
            DetailedEnumValueInfo::make_friendly_name("FX (Gloomy)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/gloomy")
         ),
         DetailedEnumValue("fx_juicy",
            DetailedEnumValueInfo::make_friendly_name("FX (Juicy)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/juicy")
         ),
         DetailedEnumValue("fx_nova",
            DetailedEnumValueInfo::make_friendly_name("FX (Nova)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/nova")
         ),
         DetailedEnumValue("fx_olde_timey",
            DetailedEnumValueInfo::make_friendly_name("FX (Olde Timey)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/olde_timey")
         ),
         DetailedEnumValue("fx_pen_and_ink",
            DetailedEnumValueInfo::make_friendly_name("FX (Pen And Ink)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/pen_and_ink")
         ),
         DetailedEnumValue("fx_purple",
            DetailedEnumValueInfo::make_friendly_name("FX (Purple)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/dusk"),
         ...
         DetailedEnumValue("fx_orange",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/golden_hour")
         ),
         DetailedEnumValue("fx_green",
            DetailedEnumValueInfo::make_friendly_name("FX (Green)"),
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/shared/screen_fx_orb/fx/eerie"),
         ...
         DetailedEnumValue("grid",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "objects/levels/forge/ff_grid_object/ff_grid_object"),
         ...
         DetailedEnumValue("sound_emitter_alarm_1",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/invisible_cube_of_derek/invisible_cube_of_alarming_1"),
         ...
         DetailedEnumValue("sound_emitter_alarm_2",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/invisible_cube_of_derek/invisible_cube_of_alarming_2"),
         ...
         DetailedEnumValue("safe_boundary",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/boundaries/safe_volume"),
         ...
         DetailedEnumValue("soft_safe_boundary",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/boundaries/soft_safe_volume"),
         ...
         DetailedEnumValue("kill_boundary",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/boundaries/kill_volume"),
         ...
         DetailedEnumValue("soft_kill_boundary",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "objects/multi/boundaries/soft_kill_volume"),
         ...
         DetailedEnumValue("unsc_data_core_holder",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "objects/multi/package_cabinet/package_cabinet"),
         ...
         DetailedEnumValue("covenant_power_module_stand",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("mach"), "objects/props/covenant/cov_powermodule_stand/cov_powermodule_stand"),
         ...
         DetailedEnumValue("covenant_bomb",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("weap"), "levels/multi/dlc/objects/dlc_covenant_bomb/dlc_covenant_bomb"),
         ...
         DetailedEnumValue("heavy_barrier",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("bloc"), "levels/multi/dlc/objects/dlc_invasion_heavy_shield/dlc_invasion_heavy_shield"),
         ...
         DetailedEnumValue("breakpoint_bomb_door",
            ...
            DetailedEnumValueInfo::make_map_tag(cobb::fourcc("scen"), "levels/multi/dlc/objects/dlc_invasion_bomb_door/dlc_invasion_bomb_door"),
